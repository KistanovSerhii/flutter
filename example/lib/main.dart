...
const String URI = "http://192.168.0.200:7000/";
...
class _MyAppState extends State<MyApp> {
  ...
  sendMessage(identifier) {
    if (sockets[identifier] != null) {
      ...
      */
      ...
      sockets[identifier].emit("message", ["Hello world by flutter!"]);
      pprint("sended message");
    }
  }
  ...
  sendMessageWithACK(identifier) {
    ...
    */
    ...
    sockets[identifier].emitWithAck("callback-message", ["Hello world by flutter!"]).then( (data) {
      // this callback runs when this specific message is acknowledged by the server
      pprint("server answer callback is : $data");
    });
  }
